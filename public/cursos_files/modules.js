...
install("fourseven:scss");                                                                                             // 70
install("jquery", "meteor/jquery/main.js");                                                                            // 71
install("materialize:materialize");                                                                                    // 72
install("reactive-dict");                                                                                              // 73
install("kadira:flow-router");                                                                                         // 74
...
install("kadira:blaze-layout");                                                                                        // 83
...
install("service-configuration");                                                                                      // 91
install("session");                                                                                                    // 92
install("less");                                                                                                       // 93
install("accounts-ui-unstyled");                                                                                       // 94
install("accounts-ui");                                                                                                // 95
install("webapp");                                                                                                     // 96
install("livedata");                                                                                                   // 97
